...
$(".my_btn_login").click(function () {
        console.log("hahha");
        console.log($('#login_name').val(),$('#login_pass').val());
...
$('#my_btn_register').click(function () {
        console.log($('#register_name').val(),$('#register_pass').val());
        socket.emit('my_register_event', {username: $('#register_name').val(),studentid: $('#register_id').val(),
            email: $('#register_email').val(),password :$('#register_pass').val()});
});
//register_tips_event
...
//     cb();
// });
// var my_btn_login=document.getElementsByClassName("my_btn_login")[0];
...
$('.register .form-membership2').click(function(event){
         event.stopPropagation();
  });
